...
public class DbConfig {
    ...
    public DataSource dbDataSource() {
        ...
        dataSource.setDriverClassName(System.getenv("DRIVER_CLASS_NAME") != null ? System.getenv("DRIVER_CLASS_NAME") :env.getProperty("spring.datasource.org.postgresql.Driver") );
